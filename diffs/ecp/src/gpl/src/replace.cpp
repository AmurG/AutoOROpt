...
bool Replace::initNesterovPlace(int threads)
{
  ...
  if (!np_) {
   ...
   npVars.disableRevertIfDiverge = disableRevertIfDiverge_;
    ...
    TimingBase::DynamicWeightOptions dyn_options;
    dyn_options.enable
        = npVars.timingDrivenMode && npVars.td_enable_dynamic_weights;
    dyn_options.weight_min = npVars.td_weight_min;
    dyn_options.weight_max = npVars.td_weight_max;
    dyn_options.congestion_alpha = npVars.td_congestion_alpha;
    dyn_options.ramp_iterations = npVars.td_ramp_iterations;
    dyn_options.update_period = npVars.td_update_period;
    dyn_options.initial_coverage_percent = npVars.td_initial_nets_percent;
    dyn_options.final_coverage_percent = npVars.td_final_nets_percent;
    dyn_options.slack_norm = npVars.td_slack_norm;
    dyn_options.length_norm = npVars.td_length_norm;
    dyn_options.overflow_limit = npVars.td_overflow_limit;
    dyn_options.severity_slack_norm = npVars.td_severity_slack_norm;
    dyn_options.severity_ratio_cap = npVars.td_severity_ratio_cap;
    dyn_options.severity_weight_scale = npVars.td_severity_weight_scale;
    dyn_options.severity_weight_limit = npVars.td_severity_weight_limit;
    dyn_options.severity_coverage_scale = npVars.td_severity_coverage_scale;
    dyn_options.severity_coverage_limit = npVars.td_severity_coverage_limit;
    dyn_options.top_endpoints = npVars.td_top_endpoints;
    dyn_options.endpoint_slack_threshold = npVars.td_slack_thresh;
    tb_->setDynamicWeightOptions(dyn_options);
    rs_->setNonCriticalSlackBudget(npVars.td_noncrit_slack_budget_ns);
